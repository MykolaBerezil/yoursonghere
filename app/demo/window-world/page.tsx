...
export default function WindowWorldDemo() {
  ...
  return (
    <div className="demo-page">
      ...
      <div className="demo-content">
        ...
        <h1 className="demo-title">Window World</h1>
        <p className="demo-subtitle">&ldquo;Simply the Best for Less&rdquo;</p>

        <div className="demo-player">
          <audio ref={audioRef} src="/audio/WindowWorldDemo.mp3" preload="metadata" />
        ...
        <a href="mailto:scotty.campbell@yoursonghere.com?subject=Window%20World%20Jingle%20Interest" className="demo-cta-btn">
          Get in Touch
        </a>
